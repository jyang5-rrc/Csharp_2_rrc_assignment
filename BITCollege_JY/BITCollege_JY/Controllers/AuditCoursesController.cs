...
namespace BITCollege_JY.Controllers
{
    public class AuditCoursesController : Controller
    {
        ...
        {
            var courses = db.AuditCourse.Include(a => a.AcademicProgram);
        ...
        public ActionResult Create([Bind(Include = "CourseId,AcademicProgramId,CourseNumber,Title,CreditHours,TuitionAmount,Notes")] AuditCourse auditCourse)
        {
            ...
            ViewBag.AcademicProgramId = new SelectList(db.AcademicPrograms, "AcademicProgramId", "ProgramAcornym", auditCourse.AcademicProgramId);
            return View(auditCourse);
        }
