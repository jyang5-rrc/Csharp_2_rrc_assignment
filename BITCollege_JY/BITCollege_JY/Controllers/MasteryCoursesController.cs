...
namespace BITCollege_JY.Controllers
{
    public class MasteryCoursesController : Controller
    {
        ...
        {
            var courses = db.MasteryCourse.Include(m => m.AcademicProgram);
        ...
        public ActionResult Details(int? id)
        {
            ...
            MasteryCourse masteryCourse = db.MasteryCourse.Find(id);
        ...
        public ActionResult Create([Bind(Include = "CourseId,AcademicProgramId,CourseNumber,Title,CreditHours,TuitionAmount,Notes,MaximumAttempts")] MasteryCourse masteryCourse)
        {
            ...
            {
                db.MasteryCourse.Add(masteryCourse);
                db.SaveChanges();
                return RedirectToAction("Index");
            }

            ViewBag.AcademicProgramId = new SelectList(db.AcademicPrograms, "AcademicProgramId", "ProgramAcornym", masteryCourse.AcademicProgramId);
            return View(masteryCourse);
        }
        ...
        {
            MasteryCourse masteryCourse = db.MasteryCourse.Find(id);
            db.MasteryCourse.Remove(masteryCourse);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
