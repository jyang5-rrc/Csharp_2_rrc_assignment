...
namespace BITCollege_JY.Controllers
{
    public class AcademicProgramsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AcademicProgramId,ProgramAcornym,Description")] AcademicProgram academicProgram)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AcademicProgramId,ProgramAcornym,Description")] AcademicProgram academicProgram)
        {
            if (ModelState.IsValid)
            {
